...
export default function Sidebar() {
  ...
  const links = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill={isLinkActive("/movies") ? "#fff" : "#000"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill={isLinkActive("/theaters") ? "#fff" : "#000"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill={isLinkActive("/showtimes") ? "#fff" : "#000"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill={isLinkActive("/users") ? "#fff" : "#000"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill={isLinkActive("/settings") ? "#fff" : "#000"}
  ...
  return (
    <div
      className={`h-screen bg-white p-6 flex flex-col justify-between transition-all duration-300 ease-in-out flex-shrink-0 overflow-hidden ${
        isOpen ? "w-64" : "w-16"
      }`}
    >
      <div className="flex flex-col gap-10">
        <div className="flex items-center gap-2">
          ...
          <p
            className={`text-2xl font-bold font-mono transition-opacity duration-300 whitespace-nowrap ${
        ...
        <div className="flex flex-col gap-1 transition-all duration-300 ease-in-out">
          {links.map((link) => (
            ...
            >
              ...
              <p
                className={`text-sm font-mono font-medium transition-opacity duration-300 whitespace-nowrap ${
                  isOpen ? "opacity-100" : "opacity-0"
                } ${isLinkActive(link.href) ? "text-white" : "text-gray-500"}`}
              >
                {link.label}
              </p>
            </Link>
